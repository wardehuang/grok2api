    ...
    translation: {
      ...
      settings: {
        ...
        accounts: {
          ...
          consoleGuardTitle: "Console 降智防护",
          consoleGuardEnabled: "启用 Console 降智防护",
          consoleGuardEnabledHelp: "扣住 Console 流式响应检测真实思考：30 秒内无 reasoning 内容且可见输出 ≥8 token 即判定降智，自动换号（最多 5 个账号），全部失败返回 503；命中降智的账号会立即停用，需在账号页手动恢复。",
          consoleGuardEventsTitle: "最近降智事件（24 小时）",
          consoleGuardEventsEmpty: "暂无 Console 降智事件",
          consoleGuardEventsFailed: "读取降智事件失败",
        },
