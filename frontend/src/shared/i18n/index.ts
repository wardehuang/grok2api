  ...
  "zh-CN": {
    translation: {
      ...
      audits: {
        ...
        consoleGuardObservationDuration: "扫描耗时",
        consoleGuardUpstreamDuration: "上游耗时",
        consoleGuardGenerationWindow: "本次 attempt TPS 分母（扫描耗时 − 本次 attempt 首个 Token）",
        consoleGuardFirstVisible: "本次 attempt 首个 Token（首个可见内容）",
  ...
  en: {
    translation: {
      ...
      audits: {
        ...
        consoleGuardObservationDuration: "Scan duration",
        consoleGuardUpstreamDuration: "Upstream duration",
        consoleGuardGenerationWindow: "This attempt TPS denominator (scan duration - this attempt first token)",
        consoleGuardFirstVisible: "This attempt first token (first visible content)",
