  ...
  "zh-CN": {
    translation: {
      ...
      qualityGuard: {
        ...
        consoleGuard: {
          tab: "Console 防护", title: "Console 降智防护", enabled: "启用 Console 降智防护", enabledStatus: "已启用", disabledStatus: "已停用",
          enabledHelp: "扣住完整 Console 流，收到终止事件后使用上游最终 usage 计算 Token/s 并决定 deliver 或 withhold。命中后自动换号并立即停用账号，需手动恢复。保存后立即热生效。",
          thresholdsTitle: "首字超时、TPS 与 burst 判定阈值", thresholdsHelp: "首字必须在等待窗口内出现；首字及时出现后，流可以继续任意时长并扣住到结束再结算。TPS 判定仅在生成窗口成熟后执行；TPS 未命中时，慢首字、短生成窗口、高 token 三项同时满足也判定降智。",
          holdTimeoutSeconds: "首字等待超时（秒）", softTPS: "软阈值（Token/s）", hardTPS: "硬阈值（Token/s）", firstTokenThresholdMS: "慢首字阈值（ms）", generationWindowThresholdMS: "最小 TPS 窗口 / burst 上限（ms）", minOutputReasoningTokens: "最少 output+reasoning token", thresholdsInvalid: "请输入有效阈值：首字等待 1–600 秒、softTPS < hardTPS，且三个 burst 阈值都必须大于 0。", saveThresholds: "保存判定阈值", thresholdsSaved: "判定阈值已更新", thresholdsSaveFailed: "判定阈值保存失败",
          saved: "Console 降智防护已更新", saveFailed: "Console 降智防护保存失败",
          recordNonDegradedEvents: "记录未降智事件", recordNonDegradedEventsHelp: "开启后，每个 Console 请求都会在降智事件中保留一条绿色或黄色记录；关闭后只保留实际命中降智的请求。",
          requestLogEnabled: "是否开启Request Log", requestLogEnabledHelp: "开启后，仅记录经过 Console Guard 的 grok_console 流式请求：完整客户端请求体、账号与出口信息、脱敏后的上游响应头、原始 SSE 字节、每个 chunk/event 的纳秒时间戳、Guard 信号与最终结果。目录上限 1 GiB，超限自动删除最旧请求。",
          requestLogSaved: "Request Log 设置已更新", requestLogSaveFailed: "Request Log 设置保存失败", requestLogDelete: "删除Request Log", requestLogDeleteHelp: "删除所有已完成 Request Log；仍在处理的日志会在请求结束后删除。", requestLogDeleteConfirmTitle: "删除全部 Request Log？", requestLogDeleteConfirmDescription: "此操作不可恢复。不会删除普通审计记录或降智代理节点文件。", requestLogDeleted: "已删除 {{count}} 条 Request Log；{{active}} 条活跃日志已排队删除。", requestLogDeleteFailed: "Request Log 删除失败",
      ...
      audits: {
        ...
        detailTitle: "请求诊断详情",
        consoleGuardTitle: "Console 降智判定详情",
        consoleGuardDecision: "判定",
        consoleGuardAction: "动作",
        consoleGuardSkipReason: "跳过原因",
        consoleGuardAttempts: "所有扫描尝试",
        consoleGuardThinkingDetected: "检测到真实思考：本条不应被判定为降智",
        consoleGuardThinkingMissing: "未检测到真实思考：满足降智条件",
        consoleGuardDecisionReasons: "为何判定为降智",
        consoleGuardMetrics: "流扫描统计",
        consoleGuardProtocol: "协议",
        consoleGuardAttempt: "降智尝试 / 上限",
        consoleGuardSoftTPS: "TPS 软阈值",
        consoleGuardHardTPS: "TPS 硬阈值",
        consoleGuardFirstTokenThreshold: "慢首字阈值",
        consoleGuardGenerationWindowThreshold: "burst 生成窗口上限",
        consoleGuardMinOutputReasoningTokens: "burst 最少 output+reasoning token",
        consoleGuardHoldTimeout: "首字等待窗口",
        consoleGuardVisibleRunes: "可见字符",
        consoleGuardVisibleTokens: "估算可见 Token",
        consoleGuardEffectiveOutputTokens: "有效 output token",
        consoleGuardEffectiveReasoningTokens: "有效 reasoning token",
        consoleGuardTPS: "检测 TPS",
        consoleGuardObservationDuration: "本次账号 attempt 扫描耗时",
        consoleGuardUpstreamDuration: "本次账号 attempt 上游耗时",
        consoleGuardGenerationWindow: "本次账号 attempt TPS 分母（attempt 耗时 − 首个生成 delta）",
        consoleGuardFirstVisible: "本次账号 attempt 首个生成 delta",
        consoleGuardNotObserved: "未观察到",
        consoleGuardNotAvailable: "N/A（未观察到生成 delta）",
        consoleGuardTerminal: "流已终止",
        consoleGuardHoldExpired: "检测窗口已到期",
        consoleGuardAccountDisabled: "账号已停用",
        consoleGuardUsage: "上游 Usage",
        consoleGuardUsageReported: "上游已报告 Usage",
        consoleGuardUsageInputTokens: "上游 input token",
        consoleGuardUsageOutputTokens: "上游 output token",
        consoleGuardUsageReasoningTokens: "上游 reasoning token",
        consoleGuardUsageTotalTokens: "上游 total token",
        consoleGuardReasoningStarted: "出现 reasoning 起始标记",
        consoleGuardThinkingEvidence: "真实思考证据",
        consoleGuardStartEvidence: "Reasoning 起始证据",
        consoleGuardNoEvidence: "没有观察到证据",
        yes: "是",
        no: "否",
  ...
  en: {
    translation: {
      ...
      qualityGuard: { title: "Quality guard", description: "Monitor Grok egress quality and quarantine anomalous nodes automatically.", overview: "Quality guard overview", serviceStatus: "Guard service", running: "Running", stale: "Status stale", mode: "Detection mode", availableNodes: "Enabled nodes", quarantinedNodes: "Quarantined", modes: { active: "Active probes", passive: "Passive audits", hybrid: "Hybrid" }, nodes: "Node quality", nodesHelp: "Speed matches the grok2api panel: output tokens include reasoning tokens. A tail shorter than the first-token wait and under 1s uses the full request duration so encrypted thinking is not crushed into the flush. A completed user request with anomalous throughput is isolated immediately, then verified with a controlled probe after the hold.", updatedAt: "Updated {{time}}", node: "Node", state: "State", outputTPS: "Panel output speed", firstToken: "First token", source: "Source", strikes: "Strikes", lastObserved: "Last observed", test: "Test", sources: { active: "Active probe", passive: "Request audit" }, quarantined: "Quarantined", fixedFallback: "Fixed fallback (protected)", suspect: "Suspect", healthy: "Healthy", pending: "Pending", probeFailed: "Probe failed", events: "Recent events", noEvents: "No anomaly or recovery events", eventTypes: { node_quarantined: "Node quarantined", node_restored: "Node restored", node_rotated: "Node IP rotated", passive_audit_anomaly: "Anomalous request detected" }, statistics: "Automatic detection statistics", statisticsSince: "Accumulated since {{time}}. Manual tests are excluded.", statisticsChecks: "Valid checks", statisticsChecksHelp: "Active probes and valid passive audits", statisticsActive: "Active probes", statisticsActiveDetail: "Healthy {{healthy}}, errors {{errors}}", statisticsPassive: "Passive audits", statisticsPassiveDetail: "Healthy {{healthy}}, from real requests", statisticsTokens: "Active output tokens", statisticsTokensHelp: "Includes reasoning tokens; not proxy traffic", statisticsAnomalies: "Anomaly hits", statisticsAnomalyDetail: "Soft {{soft}}, hard {{hard}}", statisticsQuarantines: "Quarantines applied", statisticsActionDetail: "Restored {{restored}}, protected {{suppressed}}", reasons: { unknown: "No reason recorded", hard_tps: "Hard threshold exceeded", soft_tps: "Soft threshold exceeded", buffered_burst: "Short-window output burst; retesting the same IP", missing_thinking: "Missing thinking tokens", passive_hard_tps: "Request exceeded hard threshold", passive_soft_tps: "Request exceeded soft threshold", quality_probe_healthy: "Model quality probe recovered", expected_marker_missing: "Expected marker missing", insufficient_output_tokens: "Too few output tokens", insufficient_visible_tokens: "Too few visible tokens", insufficient_generation_window: "Generation window too short", probe_errors: "Repeated probe errors", probe_no_account: "No schedulable probe account; retry deferred", recovery_probe_error: "Recovery probe failed", rotation_error: "IP rotation failed" }, policy: "Current policy", editPolicy: "Edit policy", editPolicyTitle: "Edit quality guard policy", editPolicyDescription: "The guard hot-reloads saved changes without a service restart.", restoreDefaults: "Restore defaults", policySaved: "Policy saved and queued for hot reload", invalidPolicyValue: "Value is outside the allowed range", softThresholdMustBeLower: "The soft threshold must be lower than the hard threshold", activeIntervalSeconds: "Active interval (seconds)", passiveIntervalSeconds: "Passive interval (seconds)", consecutiveSoft: "Consecutive active soft strikes", consecutiveErrors: "Consecutive probe errors", quarantineSeconds: "Quarantine (seconds)", softThreshold: "Soft threshold", hardThreshold: "Hard threshold", activeInterval: "Active interval", passiveInterval: "Audit interval", quarantineDuration: "Quarantine", minimumNodes: "Minimum nodes", unavailable: "Quality guard is not connected", unavailableHelp: "Enable qualityGuard in config.yaml and start the quality-guard Compose profile to display live status here.", testing: "Testing node quality", testComplete: "Test complete: {{speed}}", testFailed: "Quality test is temporarily unavailable. Try again shortly.", refreshNodes: "Refresh nodes", nodeEnabled: "Node enabled", nodeDisabled: "Node disabled", nodesEnabled: "Selected nodes enabled", nodesDisabled: "Selected nodes disabled", enableNode: "Enable node {{name}}", disableNode: "Disable node {{name}}", nodeEditorDescription: "Manage Grok Build egress used by the quality guard. Proxy URLs are write-only; leave the field blank while editing to keep the current value.", nodeCapacityHelp: "Maximum number of bound accounts; 0 means unlimited.", deleteNodeTitle: "Delete proxy node?", deleteNodeDescription: "Node “{{name}}” will be permanently deleted. This action cannot be undone.", deleteNodesTitle: "Delete {{count}} selected nodes?", deleteNodesDescription: "The selected proxy nodes will be permanently deleted. This action cannot be undone.",
        ...
        consoleGuard: {
          tab: "Console guard", title: "Console quality guard", enabled: "Enable Console quality guard", enabledStatus: "Enabled", disabledStatus: "Disabled",
          enabledHelp: "Withholds the complete Console stream, then uses final upstream usage at the terminal event to decide deliver or withhold. The gateway retries another account and disables a degraded account immediately. Changes apply immediately.",
          thresholdsTitle: "First-token timeout, TPS and burst thresholds", thresholdsHelp: "The first token must arrive within the wait window. Once it arrives in time, the stream may continue for any duration and remains withheld until completion. TPS is checked only after the generation window matures; otherwise slow first token + short generation window + high token count must all match.",
          holdTimeoutSeconds: "First-token wait timeout (seconds)", softTPS: "Soft threshold (Token/s)", hardTPS: "Hard threshold (Token/s)", firstTokenThresholdMS: "Slow first-token threshold (ms)", generationWindowThresholdMS: "Minimum TPS window / burst maximum (ms)", minOutputReasoningTokens: "Minimum output+reasoning tokens", thresholdsInvalid: "Enter valid thresholds: first-token wait 1–600 seconds, softTPS < hardTPS, and all three burst thresholds greater than 0.", saveThresholds: "Save decision thresholds", thresholdsSaved: "Decision thresholds updated", thresholdsSaveFailed: "Failed to save decision thresholds",
          saved: "Console quality guard updated", saveFailed: "Failed to save Console quality guard",
          recordNonDegradedEvents: "Record non-degraded events", recordNonDegradedEventsHelp: "When enabled, every Console request keeps one green or yellow event; when disabled, only requests that hit degradation are kept.",
          requestLogEnabled: "Enable Request Log", requestLogEnabledHelp: "Records only grok_console streaming requests inspected by Console Guard: the complete client body, account and egress metadata, redacted upstream response headers, exact SSE bytes, nanosecond timestamps for every chunk/event, Guard signals, and final outcome. Storage is capped at 1 GiB and the oldest requests are deleted automatically.",
          requestLogSaved: "Request Log setting updated", requestLogSaveFailed: "Failed to save Request Log setting", requestLogDelete: "Delete Request Log", requestLogDeleteHelp: "Deletes all completed Request Logs. Active logs are deleted when their requests finish.", requestLogDeleteConfirmTitle: "Delete all Request Logs?", requestLogDeleteConfirmDescription: "This cannot be undone. Standard audit records and the degraded proxy-node file are not deleted.", requestLogDeleted: "Deleted {{count}} Request Logs; {{active}} active logs queued for deletion.", requestLogDeleteFailed: "Failed to delete Request Logs",
      ...
      audits: {
        ...
        consoleGuardTitle: "Console degrade decision details",
        consoleGuardDecision: "Decision",
        consoleGuardAction: "Action",
        consoleGuardSkipReason: "Skip reason",
        consoleGuardAttempts: "All scan attempts",
        consoleGuardThinkingDetected: "Real thinking detected: this stream should not be classified as degraded",
        consoleGuardThinkingMissing: "No real thinking detected: degrade conditions were met",
        consoleGuardDecisionReasons: "Why this was classified as degraded",
        consoleGuardMetrics: "Stream scan metrics",
        consoleGuardProtocol: "Protocol",
        consoleGuardAttempt: "Degrade attempt / limit",
        consoleGuardSoftTPS: "TPS soft threshold",
        consoleGuardHardTPS: "TPS hard threshold",
        consoleGuardFirstTokenThreshold: "Slow first-token threshold",
        consoleGuardGenerationWindowThreshold: "Burst generation-window maximum",
        consoleGuardMinOutputReasoningTokens: "Burst minimum output+reasoning tokens",
        consoleGuardHoldTimeout: "First-token wait window",
        consoleGuardVisibleRunes: "Visible characters",
        consoleGuardVisibleTokens: "Estimated visible tokens",
        consoleGuardEffectiveOutputTokens: "Effective output tokens",
        consoleGuardEffectiveReasoningTokens: "Effective reasoning tokens",
        consoleGuardTPS: "Inspection TPS",
        consoleGuardObservationDuration: "Current account attempt scan duration",
        consoleGuardUpstreamDuration: "Current account attempt upstream duration",
        consoleGuardGenerationWindow: "Current account attempt TPS denominator (attempt duration - first generated delta)",
        consoleGuardFirstVisible: "Current account attempt first generated delta",
        consoleGuardNotObserved: "Not observed",
        consoleGuardNotAvailable: "N/A (no generated delta observed)",
        consoleGuardTerminal: "Stream terminated",
        consoleGuardHoldExpired: "Inspection window expired",
        consoleGuardAccountDisabled: "Account disabled",
        consoleGuardUsage: "Upstream usage",
        consoleGuardUsageReported: "Upstream usage reported",
        consoleGuardUsageInputTokens: "Upstream input tokens",
        consoleGuardUsageOutputTokens: "Upstream output tokens",
        consoleGuardUsageReasoningTokens: "Upstream reasoning tokens",
        consoleGuardUsageTotalTokens: "Upstream total tokens",
        consoleGuardReasoningStarted: "Reasoning start marker observed",
        consoleGuardThinkingEvidence: "Real-thinking evidence",
        consoleGuardStartEvidence: "Reasoning-start evidence",
        consoleGuardNoEvidence: "No evidence observed",
        yes: "Yes",
        no: "No",
