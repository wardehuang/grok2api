  ...
  "zh-CN": {
    translation: {
      ...
      audits: {
        ...
        consoleGuardGenerationWindow: "TPS 分母（扫描耗时 − 首个 Token）",
        consoleGuardFirstVisible: "首个 Token（首个可见内容）",
  ...
  en: {
    translation: {
      ...
      audits: {
        ...
        consoleGuardGenerationWindow: "TPS denominator (scan duration − first token)",
        consoleGuardFirstVisible: "First token (first visible content)",
