  ...
  "zh-CN": {
    translation: {
      ...
      audits: {
        ...
        consoleGuardObservationDuration: "请求耗时（含 Guard/换号）",
        consoleGuardUpstreamDuration: "上游耗时",
        consoleGuardGenerationWindow: "本次请求 TPS 分母（请求耗时 − 首个 Token）",
        consoleGuardFirstVisible: "本次请求首个 Token（与主审计 generated delta 同口径）",
  ...
  en: {
    translation: {
      ...
      audits: {
        ...
        consoleGuardObservationDuration: "Request duration (including Guard/retries)",
        consoleGuardUpstreamDuration: "Upstream duration",
        consoleGuardGenerationWindow: "This request TPS denominator (request duration - first token)",
        consoleGuardFirstVisible: "This request first token (same generated-delta rule as main audit)",
